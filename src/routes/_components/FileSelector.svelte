<script lang="ts">
	...
	function getRootObjects(dirs: Map<string, number>, baseDir: string): fileObject[] {
	...
	let current_dirs: fileObject[] = fileManager.placeholderDirectoryTree().map((x) => {
		return {
			name: x,
			path: x,
			fileType: 'folder'
...
<table class="selector">
	...
	{#each current_dirs as dir}
		<tr class="obj-row">
			<td class="obj-checkbox" class:partially-selected={partialValues[dir.path]}>
